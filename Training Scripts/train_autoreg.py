...
# CHILDES env vars
#train_file = os.environ["CHILDES_TRAIN"]
#dev_file = os.environ["CHILDES_DEV"]
train_file="data/corpora/babylm_data/babylm_100M/babylm_100M_train.txt"
dev_file="data/corpora/babylm_data/babylm_dev/babylm_dev.txt"
...
class ModelArguments:
    ...
    early_stopping: bool = field(
        ...
        metadata={
            "help": (
                "Whether to use early stopping to stop training when the model is not improving. "
            )
        },
    )
